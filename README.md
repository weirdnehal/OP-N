...
``` shell script
THIS TOOLS IS PAID. PURCHASE TOOLS PASSWORD TO RUN, NO NEED
```
...
* [+] Easy for beginners !
* [+] Working OP-N tool for termux & kali linux !
...
pip install rich
pip install requests
git clone https://github.com/weirdnehal/OP-N.git
cd OP-N
python OP-N.py
```
...
### NOTE: THIS TOOLS IS PAID. PURCHASE TOOLS PASSWORD TO RUN, NO NEED
